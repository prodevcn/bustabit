define([
    ...
    function Engine() {
        ...
        self.ws.on('updated_jackpot_success', function(data) {
            console.log("Old Game Engine Store", data);
        ...
        self.ws.on('jackpot_run_starting', function(s) {
            ...
            // $('.max-profit').css('opacity', '0');
            // $('.history-bar').css('opacity', '0');
        });
        ...
        self.ws.on('connect', function() {
            ...
            requestOtt(function(err, ott) {
                ...
                self.ws.emit('join', {
                    ...
                    self.jackpotState = resp.jackpotState;
                    self.jackpotCustomData = resp.jackpotCustomData;
