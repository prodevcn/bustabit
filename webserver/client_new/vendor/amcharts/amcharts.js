...
AmCharts.Class = function (a) {
  var b = function () {
    arguments[0] !== AmCharts.inheriting &&
      ((this.events = {}), this.construct.apply(this, arguments));
  };
  a.inherits
    ? ((b.prototype = new a.inherits(AmCharts.inheriting)),
...
AmCharts.applyLang = function (a) {
  ...
  b &&
    ...
    ((AmCharts.lang = a),
    a.monthNames &&
      ((AmCharts.dayNames = a.dayNames),
      (AmCharts.shortDayNames = a.shortDayNames),
      (AmCharts.monthNames = a.monthNames),
      (AmCharts.shortMonthNames = a.shortMonthNames)));
};
AmCharts.IEversion = AmCharts.getIEVersion();
9 > AmCharts.IEversion &&
  0 < AmCharts.IEversion &&
  ((AmCharts.isModern = !1), (AmCharts.isIE = !0));
AmCharts.dx = 0;
AmCharts.dy = 0;
...
document.attachEvent &&
  ((AmCharts.isNN = !1),
  (AmCharts.isIE = !0),
  AmCharts.isModern || ((AmCharts.dx = 0), (AmCharts.dy = 0)));
...
AmCharts.handleLoad = function () {
  ...
  for (var a = AmCharts.onReadyArray, b = 0; b < a.length; b++) {
    var c = a[b];
    isNaN(AmCharts.processDelay)
      ? c()
      : setTimeout(c, AmCharts.processDelay * b);
  }
};
...
AmCharts.wrappedText = function (a, b, c, d, e, f, g, h, k) {
  ...
  if (l) {
    ...
    if (n.width > h) {
      ...
      for (
        var q = Math.round(b.length / 2), r = 1e3, s, p = 0;
        p < l.length;
        p++
      ) {
      ...
      if (isNaN(s)) {
        ...
        for (p = 1; p < h; p++)
          (s = Math.round((b.length / h) * p)),
            (b = b.substr(0, s) + m + b.substr(s));
...
AmCharts.toCoordinate = function (a, b, c) {
  ...
  void 0 !== a &&
    ...
    -1 != a.indexOf("%") &&
      (d = (b * Number(a.substr(0, a.length - 1))) / 100));
  return d;
};
  ...
  if (b) {
    ...
    for (k = 0; k < c.length; k++) {
      var l = c[k],
        m = b[l];
      void 0 !== m &&
        ((m = f ? AmCharts.addPrefix(m, h, g, d) : AmCharts.formatNumber(m, d)),
...
AmCharts.AxisBase = AmCharts.Class({
  ...
  positionTitle: function () {
    ...
    if (a) {
      ...
      0 < d.length()
        ? (e = d.getBBox())
        : ((e.x = 0), (e.y = 0), (e.width = this.viW), (e.height = this.viH));
      d.push(a);
      var d = e.x,
        f = e.y;
  ...
  addGuide: function (a) {
    for (var b = this.guides, c = !1, d = 0; d < b.length; d++)
      b[d] == a && (c = !0);
    c || b.push(a);
  },
...
AmCharts.ValueAxis = AmCharts.Class({
  ...
  updateData: function () {
    ...
    this.synchronizationMultiplier && this.synchronizeWith
      ? (AmCharts.isString(this.synchronizeWith) &&
        ...
        this.synchronizeWith &&
          ...
          (this.foundGraphs = !0)))
      : ((this.foundGraphs = !1), this.getMinMax());
  },
  draw: function () {
    ...
    if (
      this.logarithmic &&
      (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)
    )
      ...
      if (
        ...
        !0 === h
          ? ((r =
            ...
            r > this.logGridLimit &&
              ((q = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1),
              (p = Math.round(Math.log(this.minReal) * Math.LOG10E)),
              q > this.gridCountR && (n = Math.ceil(q / this.gridCountR))))
          : (this.stepWidth = this.axisWidth / (this.max - this.min));
        var s = 0;
        1 > this.step &&
          -1 < this.step &&
          (s = AmCharts.getDecimals(this.step));
        ...
        if (0 < y) {
          ...
          for (d = this.fillAlpha = 0; d < y; d++) {
            var E = u[d],
              ...
              z = E.above;
            isNaN(E.toValue) ||
              ((A = this.getCoordinate(E.toValue)),
              (t = new this.axisItemRenderer(this, A, "", !0, NaN, NaN, E)),
              this.pushAxisItem(t, z));
            var K = NaN;
            isNaN(E.value) ||
              ((K = this.getCoordinate(E.value)),
              ...
              this.pushAxisItem(t, z));
            isNaN(A - K) ||
              ((t = new this.guideFillRenderer(this, K, A, E)),
              this.pushAxisItem(t, z),
              (t = t.graphics()),
              (E.graphics = t),
              E.balloonText && this.addEventListeners(t, E));
          }
          this.fillAlpha = c;
        }
        u = !1;
        for (d = p; d < q; d += n)
          (y = AmCharts.roundTo(this.step * d + this.min, s)),
            -1 != String(y).indexOf("e") && ((u = !0), String(y).split("e"));
        this.duration &&
          (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
        var s = this.step,
          I,
          y = this.minorGridAlpha;
        this.minorGridEnabled &&
          (I = this.getMinorGridStep(s, this.stepWidth * s));
        for (d = p; d < q; d += n)
          if (
            ((p = s * d + this.min),
            h && this.max - this.min > 5 * this.min && (p -= this.min),
            ...
            if (isNaN(v) || Number(AmCharts.toFixed(p, v)) == p) {
              !0 === h &&
                (0 === p && (p = this.minReal),
                r > this.logGridLimit && (p = Math.pow(10, d)),
                (u = -1 != String(p).indexOf("e") ? !0 : !1));
              this.useScientificNotation && (u = !0);
              this.usePrefixes && (u = !1);
              u
                ? ((t =
                    -1 == String(p).indexOf("e")
                      ? p.toExponential(15)
                      : String(p)),
                  (c = t.split("e")),
                  (t = Number(c[0])),
                  (c = Number(c[1])),
                  (t = AmCharts.roundTo(t, 14)),
                  10 == t && ((t = 1), (c += 1)),
                  (t = t + "e" + c),
                  0 === p && (t = "0"),
                  1 == p && (t = "1"))
                : (h &&
                    ((t = String(p).split(".")),
                    t[1]
                      ? ((w.precision = t[1].length),
                        0 > d && (w.precision = Math.abs(d)))
                      : (w.precision = -1)),
                  (t = this.usePrefixes
                    ? AmCharts.addPrefix(
                        p,
                    ...
                    : AmCharts.formatNumber(p, w, w.precision)));
              this.duration &&
                (t = AmCharts.formatDuration(
                  p,
                  this.duration,
                  "",
                  this.durationUnits,
              ...
              this.labelFunction &&
                (t = this.labelFunction(p, t, this).toString());
              t = new this.axisItemRenderer(
                this,
                c,
                t,
              ...
              if (p == this.baseValue && "radar" != a.type) {
                ...
                "H" == this.orientation
                  ...
                  : 0 <= c &&
                    ...
                    ((F = [0, z, z + e]), (H = [c, c, c + f]));
                F &&
                  ((c = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1)),
                  (c = AmCharts.line(
                    a.container,
                    F,
                    H,
              ...
              if (!isNaN(I) && 0 < y && d < q - 1) {
                ...
                for (c = 1; c < s / I; c++)
                  (E = this.getCoordinate(p + I * c)),
                    (E = new this.axisItemRenderer(
                      this,
                      E,
                      "",
                      !1,
      ...
      this.positionTitle();
      "radar" != a.type
        ? ((a = this.viX), (e = this.viY), b.translate(a, e), d.translate(a, e))
        : h.toFront();
      !this.visible || g
        ? (b.hide(), h.hide(), d.hide())
        : (b.show(), h.show(), d.show());
  ...
  getMinorGridStep: function (a, b) {
    ...
    60 > b && c.shift();
    for (
      var d = Math.floor(Math.log(Math.abs(a)) * Math.LOG10E), e = 0;
      e < c.length;
      e++
    ) {
      var f = a / c[e],
      ...
      for (n = 0; n < h.length; n++)
        if (((m = h[n]), m.hidden)) m.newStack && ((e[k] = NaN), (d[k] = NaN));
          ...
          if (
            ...
            q &&
              s &&
              (s = this.data[k].axes[this.id].graphs[s.id]) &&
              (l.values.open = s.values.value);
            "regular" == b &&
              (q &&
                (isNaN(c[k])
                  ? ((c[k] = g),
                    (l.values.close = g),
                    (l.values.open = this.baseValue))
                  : (isNaN(g)
                      ? (l.values.close = c[k])
                      : (l.values.close = g + c[k]),
                    (l.values.open = c[k]),
                    (c[k] = l.values.close))),
              "column" == a &&
                (m.newStack && ((e[k] = NaN), (d[k] = NaN)),
                ...
                0 > g
                  ? ((l.values.close = g),
                    isNaN(d[k])
                      ? (l.values.open = p)
                      : ((l.values.close += d[k]), (l.values.open = d[k])),
                    (d[k] = l.values.close))
                  : ((l.values.close = g),
                    isNaN(e[k])
                      ? (l.values.open = p)
                      : ((l.values.close += e[k]), (l.values.open = e[k])),
                    (e[k] = l.values.close))));
          }
    }
    for (k = this.start; k <= this.end; k++)
            ...
            m.chart == this.chart &&
              ...
              isNaN(g) ||
                ...
                "100%" == b &&
                  ...
                  isNaN(e[k]) && (e[k] = 0),
                  0 > c
                    ? ((l.values.close = AmCharts.fitToBounds(
                        c + d[k],
                        -100,
                        100
                      )),
      ...
      if (d.valueAxis == this) {
        ...
        if (!isNaN(a.startTime) && (l = a.categoryAxis)) {
          ...
          var m = new Date(a.startTime + minDuration / 2),
            n = AmCharts.resetDateToMin(
              new Date(a.startTime),
              l.minPeriod
            ).getTime();
          AmCharts.resetDateToMin(new Date(m), l.minPeriod).getTime() > n &&
            g++;
        }
        if ((l = a.recalculateFromDate))
          a.dataDateFormat && (l = AmCharts.stringToDate(l, a.dataDateFormat)),
            (g = a.getClosestIndex(
              a.chartData,
              "time",
              l.getTime(),
            ...
            (h = a.chartData.length - 1);
        for (
          l = g;
          l <= h &&
          ((g = this.data[l].axes[this.id].graphs[d.id]),
          (f = g.values[e]),
          isNaN(f));
          l++
        );
  ...
  getMinMax: function () {
    ...
    d =
      0 === c
        ? Math.pow(10, Math.floor(Math.log(Math.abs(this.max)) * Math.LOG10E)) /
          10
        : Math.pow(10, Math.floor(Math.log(Math.abs(c)) * Math.LOG10E)) / 10;
    isNaN(this.maximum) &&
      isNaN(this.maxTemp) &&
      (this.max = Math.ceil(this.max / d) * d + d);
    isNaN(this.minimum) &&
      isNaN(this.minTemp) &&
    ...
    this.logarithmic &&
      (2 < c
        ? ((this.minReal = this.min = Math.pow(
            10,
        ...
        : ((b =
          ...
          (a =
            Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)) / 10),
  ...
  zoomToValues: function (a, b) {
    ...
    c.valueAxis = this;
    c.multiplier =
      this.axisWidth / Math.abs(this.getCoordinate(b) - this.getCoordinate(a));
    c.position =
      "V" == this.orientation
        ? this.reversed
          ? this.getCoordinate(a)
          : this.getCoordinate(b)
        : this.reversed
        ? this.getCoordinate(b)
        : this.getCoordinate(a);
    this.fire(c.type, c);
  ...
  getCoordinate: function (a) {
    ...
    var b = this.rotate,
      ...
      g = this.minReal;
    !0 === this.logarithmic
      ? ((a = Math.log(a) * Math.LOG10E - Math.log(g) * Math.LOG10E),
        (b = b ? (!0 === c ? d - e * a : e * a) : !0 === c ? e * a : d - e * a))
      : (b =
          !0 === c
            ? b
              ? d - e * (a - f)
...
AmCharts.RecAxis = AmCharts.Class({
  construct: function (a) {
    var b = a.chart,
      ...
      p = b.container;
    "H" == a.orientation
      ? ((d = AmCharts.line(p, [0, n], [0, 0], d, e, c)),
      ...
      : ((this.axisWidth = a.height),
        "right" == a.position
          ? ((d = AmCharts.line(p, [0, 0, -g], [0, m, m - h], d, e, c)),
            (a = l + h),
            (c = c / 2 + f + g + n + k - 1))
          : ((d = AmCharts.line(p, [0, 0], [0, m], d, e, c)),
            (a = l),
            (c = -c / 2 - f + k)));
    d.translate(c, a);
    b.axesSet.push(d);
  ...
  construct: function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    g
      ? ((F = !0),
        ...
        void 0 != g.lineColor && (A = g.lineColor),
        void 0 != g.color && (q = g.color),
        isNaN(g.lineAlpha) || (y = g.lineAlpha),
        isNaN(g.dashLength) || (z = g.dashLength),
        isNaN(g.lineThickness) || (E = g.lineThickness),
        !0 === g.inside && (L = !0),
        isNaN(g.labelRotation) || (m = g.labelRotation),
        isNaN(g.fontSize) || (p = g.fontSize),
        g.position && (na = g.position),
        void 0 !== g.boldLabel && (h = g.boldLabel),
        isNaN(g.labelOffset) || (ha = g.labelOffset))
      : "" === c && (u = 0);
    R = "start";
    e && (R = "middle");
    var Y = (m * Math.PI) / 180,
    ...
    F &&
      ((x =
        a.autoWrap && 0 === m
          ? AmCharts.wrappedText(r, c, q, n, p, R, h, e, 0)
          : AmCharts.text(r, c, q, n, p, R, h)),
      (R = x.getBBox()),
      (ca = R.width),
      (ja = R.height));
    if ("H" == Ra) {
      if (
        (0 <= b &&
          ...
          (0 < u &&
            0 < t &&
            b + k <= X + 1 &&
            ((oa = AmCharts.line(r, [b + k, b + k], [0, u], w, t, E)),
            s.push(oa)),
          0 < y &&
            ((R = AmCharts.line(
              r,
        ...
        !1 === d
          ? ((R = "start"),
            (B = "bottom" == na ? (L ? B + u : B - u) : L ? B - u : B + u),
            (G += 3),
            e && ((G += e / 2 - 3), (R = "middle")),
            0 < m && (R = "middle"))
          : (R = "middle"),
        1 == H &&
          ...
          !l &&
          ta < X &&
          ((d = AmCharts.fitToBounds(b, 0, X)),
          (ta = AmCharts.fitToBounds(ta, 0, X)),
          (qa = d - ta),
          0 < qa &&
            ((fill = AmCharts.rect(r, qa, a.height, K, I)),
            fill.translate(d - qa + ba, $),
            s.push(fill))),
        "bottom" == na
          ? ((B += V + p / 2 + Z),
            L
              ? (0 < m
                  ? ((B = V - (ca / 2) * Math.sin(Y) - u - 3),
                    (G += (ca / 2) * Math.cos(Y) - 4 + 2))
                  : 0 > m
                  ? ((B = V + ca * Math.sin(Y) - u - 3 + 2),
                    (G += -ca * Math.cos(Y) - ja * Math.sin(Y) - 4))
                  : (B -= u + p + 3 + 3),
                (B -= ha))
              : (0 < m
                  ? ((B = V + (ca / 2) * Math.sin(Y) + u + 3),
          ...
          : ((B += $ + p / 2 - Z),
            ...
            L
              ? (0 < m
                  ? ((B = (ca / 2) * Math.sin(Y) + u + 3),
                    (G -= (ca / 2) * Math.cos(Y)))
                  : (B += u + 3),
                (B += ha))
              : (0 < m
                  ? ((B = -(ca / 2) * Math.sin(Y) - u - 6),
                    (G += (ca / 2) * Math.cos(Y)))
                  : (B -= u + p + 3 + v + 3),
                (B -= ha))),
        "bottom" == na
        ...
        f && (G += f),
        (f = G),
        0 < m && (f += (ca / 2) * Math.cos(Y)),
        x &&
          ((p = 0), L && (p = (ca / 2) * Math.cos(Y)), f + p > X + 2 || 0 > f))
      )
        x.remove(), (x = null);
    } else {
      0 <= b &&
        ...
        (0 < u &&
          0 < t &&
          b + k <= V + 1 &&
          ((oa = AmCharts.line(r, [0, u], [b + k, b + k], w, t, E)),
          s.push(oa)),
        0 < y &&
          ((R = AmCharts.line(
            r,
      ...
      1 == H &&
        ...
        !g &&
        !l &&
        ((d = AmCharts.fitToBounds(b, 0, V)),
        (ta = AmCharts.fitToBounds(ta, 0, V)),
        (Y = d - ta),
        (fill = AmCharts.polygon(
          r,
          [0, a.width, a.width, 0],
          [0, 0, Y, Y],
          K,
      ...
      "right" == na
        ...
        ? ((G += u + 4 - Z),
          ...
          g && ((G += ba), (B += $)),
          (G += ha))
        : ((G += -u - v - 4 - 2 - Z), (B -= 2), (G -= ha));
      oa &&
        ("right" == na
          ? ((W += ba + Z + X), (qa += $), (W = L ? W - v : W + v))
          : ((W -= Z), L || (W -= u + v)));
      f && (B += f);
      L = -3;
      "right" == na && (L += $);
    ...
    x &&
      (x.attr({ "text-anchor": R }),
      x.translate(G, B),
      0 !== m && x.rotate(-m, a.chart.backgroundColor),
      a.allLabels.push(x),
      " " != c && (this.label = x));
...
AmCharts.RecFill = AmCharts.Class({
  construct: function (a, b, c, d) {
    ...
    d = d.fillColor;
    "V" == g
      ? ((b = AmCharts.fitToBounds(b, 0, a.viH)),
        (c = AmCharts.fitToBounds(c, 0, a.viH)))
      : ((b = AmCharts.fitToBounds(b, 0, a.viW)),
        (c = AmCharts.fitToBounds(c, 0, a.viW)));
    c -= b;
    isNaN(c) && ((c = 4), (h = 2), (l = 0));
    0 > c && "object" == typeof d && (d = d.join(",").split(",").reverse());
    "V" == g
      ? ((a = AmCharts.rect(k, a.width, c, d, l)), a.translate(e, b - h + f))
      : ((a = AmCharts.rect(k, c, a.height, d, l)), a.translate(b - h + e, f));
    this.set = k.set([a]);
  },
  graphics: function () {
    return this.set;
...
AmCharts.AmChart = AmCharts.Class({
  ...
  measure: function () {
    ...
    if (a) {
      ...
      this.balloon = AmCharts.processObject(
        this.balloon,
        AmCharts.AmBalloon,
        this.theme
      );
      this.balloon.chart = this;
      (a != this.previousWidth || f != this.previousHeight) &&
        0 < a &&
        0 < f &&
        ((b.style.width = a + "px"),
        (b.style.height = f + "px"),
  ...
  drawLabel: function (a) {
    if (this.container) {
      ...
      "center" == d &&
        ((d = "middle"),
        g ? (b = this.realHeight - b + b / 2) : (l = this.realWidth / 2 - l));
      void 0 === h && (h = 1);
      void 0 === g && (g = 0);
      b += e / 2;
  ...
  validateSize: function () {
    ...
    var b = a.legend;
    if (
      (a.realWidth != a.previousWidth || a.realHeight != a.previousHeight) &&
      0 < a.realWidth &&
      0 < a.realHeight
    ) {
      a.sizeChanged = !0;
  ...
  validateData: function (a) {
    this.chartCreated &&
      ((this.dataChanged = !0),
      (this.marginsUpdated = "xy" != this.type ? !1 : !0),
      this.initChart(a));
  },
  ...
  showBalloonReal: function (a, b, c, d, e) {
    ...
    f.enabled &&
      ...
      f.changeColor(b),
      !c || f.fixedPosition
        ? (f.setPosition(d, e), f.followCursor(!1))
        : f.followCursor(!0),
      a && f.showBalloon(a));
  },
      ...
      if (d <= c) {
        ...
        0 === h
          ? (this.animations.splice(a, 1),
            (e.node.style[f] = Number(b.to) + b.suffix))
          : (e.node.style[f] = c + b.suffix);
      } else
        (e.node.style[f] = Number(b.to) + b.suffix),
          this.animations.splice(a, 1);
    }
  ...
  brr: function () {
    ...
    if ("amcharts.com" != b || !0 === this.inIframe()) {
      ...
      "ammap" == this.product &&
        ((f = "http://www.ammap.com/javascript-maps/"),
        (g = "Interactive JavaScript maps"),
...
AmCharts.AmGraph = AmCharts.Class({
  ...
  draw: function () {
    ...
    var c = b.set(),
      d = b.set();
    this.behindColumns
      ? (a.graphsBehindSet.push(c), a.bulletBehindSet.push(d))
      : (a.graphsSet.push(c), a.bulletSet.push(d));
    ...
    AmCharts.ifArray(this.data) &&
      ((c = !1),
      "xy" == this.chart.type
        ? this.xAxis.axisCreated && this.yAxis.axisCreated && (c = !0)
        : this.valueAxis.axisCreated && (c = !0),
      !this.hidden && c && this.createGraph());
  },
  createGraph: function () {
    var a = this,
      b = a.chart;
    "inside" == a.labelPosition &&
      "column" != a.type &&
  ...
  createXYGraph: function () {
    ...
    for (e = this.start; e <= this.end; e++) {
      ...
      !isNaN(h) &&
        ...
        (a.push(g),
        b.push(l),
        (h = this.createBullet(f, g, l, e)) || (h = 0),
        (k = this.labelText)) &&
        ((f = this.createLabel(f, g, l, k)),
  ...
  createSerialGraph: function () {
    ...
    if (
      ...
      q
        ? ((jb = n),
          ...
          (nb = Math.abs(eb - Aa)),
          (db = lb = 0),
          f.reversed ? ((bb = 0), (cb = Aa)) : ((bb = Aa), (cb = 0)))
        : ((kb = m),
          (jb = Math.abs(Fb - Aa)),
          (nb = m),
          (mb = Math.abs(eb - Aa)),
          (cb = bb = 0),
          f.reversed ? ((db = p), (lb = Aa)) : (db = Aa + 1));
    }
    var Ba = Math.round;
    this.pmx = Ba(bb);
    this.pmy = Ba(lb);
    ...
    if ("line" == g || "step" == g || "smoothedLine" == g) {
      if (0 < ha) {
        ...
        if (this.dashLengthField)
          for (J = ha; -1 < J; J--)
            if (
              ((ja = d[J]), (x = ja.axes[f.id].graphs[b]), !isNaN(x.dashLength))
            ) {
    ...
    var O = [],
      ...
      Ea = !1;
    if ("line" == g || "step" == g || "smoothedLine" == g)
      if ((this.stackable && "regular" == H) || "100%" == H || this.fillToGraph)
        Ea = !0;
    ...
    for (J = ha; J <= ba; J++) {
      ...
      if (l && void 0 == this.openField)
        for (
          ...
          pb < d.length &&
          (!d[pb] ||
            !(Va = d[J + 1].axes[f.id].graphs[b]) ||
            !Va.values ||
            ((Na = Va.values.value), isNaN(Na)));
          pb++
        );
      var S,
        T,
      ...
      if (va) {
        ...
        if ("candlestick" == g || "ohlc" == g)
          (U = va.close),
            (rb = va.low),
            (xa = f.getCoordinate(rb)),
            (qb = va.high),
            (ya = f.getCoordinate(qb));
        ka = va.open;
        C = f.getCoordinate(U);
        isNaN(ka) ||
          ((M = f.getCoordinate(ka)), l && ((Na = ka), (ka = M = NaN)));
        l &&
          (void 0 == this.openField
            ? Va && (Va.isNegative = Na < U ? !0 : !1)
            : (x.isNegative = Na > U ? !0 : !1));
        if (!$)
        ...
        var la = ja.x[Ra.id],
          ...
          ma = Math.floor(W / 2) + Math.floor((Oa * W) / 2),
          za = ma,
          Hb = 0;
        "left" == this.stepDirection &&
          ((Hb = (2 * W + Oa * W) / 2), (la -= Hb));
        "start" == this.pointPosition &&
          ((la -= W / 2 + Math.floor((Oa * W) / 2)),
          (ma = 0),
          (za = Math.floor(W) + Math.floor(Oa * W)));
        "end" == this.pointPosition &&
          ((la += W / 2 + Math.floor((Oa * W) / 2)),
          (ma = Math.floor(W) + Math.floor(Oa * W)),
          (za = 0));
        if (Gb) {
        ...
        q
          ? ((D = C),
            (N = M),
            (M = C = la),
            isNaN(ka) && !this.fillToGraph && (N = na),
            (Fa = xa),
            (Ga = ya))
          : ((N = D = la), isNaN(ka) && !this.fillToGraph && (M = na));
        U < ka &&
          ((x.isNegative = !0),
          Da && (Ca = Da),
          Ta && (Wa = Ta),
        ...
        switch (g) {
          case "line":
            if (isNaN(U))
              ...
              if (Math.abs(D - fb) >= hb || Math.abs(C - gb) >= hb)
                w.push(D), t.push(C), (fb = D), (gb = C);
              aa = D;
              ia = C;
              ea = D;
              fa = C;
              ...
              if (
                ...
                this.drawLineGraph(w, t, O, P),
                  ...
                  l
                    ? Ma
                      ? ((this.lineColorSwitched = oa),
                        (this.fillColorsSwitched = ob))
                      : ((this.lineColorSwitched = wa),
                        (this.fillColorsSwitched = Da))
          ...
          case "smoothedLine":
            if (isNaN(U))
              v ||
                (this.drawSmoothedGraph(w, t, O, P),
                (w = []),
                (t = []),
                (O = []),
                (P = []));
                ...
                q
                  ? (isNaN(u) || (w.push(u), t.push(C - ma)),
                    ...
                    !Ea ||
                      ...
                      P.push(M + za)))
                  : (isNaN(y) ||
                      (t.push(y), w.push(u), t.push(y), w.push(D - ma)),
                    w.push(D - ma),
                    t.push(C),
                    w.push(D + za),
                    t.push(C),
              ...
              if (!((U < Ib && ka < Ib) || (U > Jb && ka > Jb)))
                if (q) {
                  "3d" == H
                    ? ((T =
                        C -
                        (r / 2 - this.depthCount + 1) * (h + B) +
                        B / 2 +
                        F * V),
                      (S = N + I * V))
                    : ((T = Math.floor(C - (r / 2 - V) * (h + B) + B / 2)),
                      (S = N));
                  Q = h;
                  aa = D;
                  ia = T + h / 2;
                  ...
                  T < n &&
                    ...
                    "bottom" != L &&
                      "inside" != L &&
                      "middle" != L &&
                      ((L = f.reversed ? "left" : "right"),
                      0 > U && (L = f.reversed ? "right" : "left")),
                    "regular" == H || "100%" == H) &&
                    (aa += this.dx);
                } else {
                  "3d" == H
                  ...
                  if (S < m + V * I && 0 < Q)
                    if (
                      ...
                      0 > U && "middle" != L && "inside" != L)
                    )
                      L = "bottom";
                    else if (((L = qa), "regular" == H || "100%" == H))
                      ia += this.dy;
                }
              if (
                ra &&
                ...
                (x.url || this.showHandOnHover) &&
                  sa.setAttr("cursor", "pointer"),
                !$)
              ) {
                "none" == H && (K = q ? (this.end + 1 - J) * z - c : z * J + c);
                "3d" == H &&
                  (q
                    ? ((K = (this.end + 1 - J) * z - c - 1e3 * this.depthCount),
                      (aa += I * this.columnIndex),
                      (ea += I * this.columnIndex),
                      (x.y += I * this.columnIndex))
                    : ((K = (z - c) * (J + 1) + 1e3 * this.depthCount),
                      (aa += 3),
                      (ia += F * this.columnIndex + 7),
                      (fa += F * this.columnIndex),
                      (x.y += F * this.columnIndex)));
                if ("regular" == H || "100%" == H)
                  "inside" != L && (L = "middle"),
                    (K = q
                      ? 0 < va.value
              ...
              if (q) {
                if (
                  ...
                  !isNaN(Ga) &&
                    ...
                    C < n &&
                    0 < C &&
                    ((ib = AmCharts.line(e, ub, [C, C], pa, Z, X)),
                    (tb = AmCharts.line(e, vb, [C, C], pa, Z, X)));
                  da = D - N;
                  ra = new AmCharts.Cuboid(
                    e,
                    da,
                ...
                !isNaN(ya) &&
                  ...
                  D < m &&
                  0 < D &&
                  ((ib = AmCharts.line(e, [D, D], wb, pa, Z, X)),
                  (tb = AmCharts.line(e, [D, D], xb, pa, Z, X)));
              }
              ra &&
                ((sa = ra.set),
                (x.columnGraphics = sa),
                Y.push(sa),
                sa.translate(S, T - X / 2),
                (x.url || this.showHandOnHover) &&
                  sa.setAttr("cursor", "pointer"),
                ib && (Y.push(ib), Y.push(tb)),
                (aa = D),
                (ia = C),
                q
                  ? ((fa = C),
          ...
          case "ohlc":
            if (!(isNaN(ka) || isNaN(qb) || isNaN(rb) || isNaN(U))) {
              ...
              if (q) {
                ...
                0 < D &&
                  D < m &&
                  (yb = AmCharts.line(e, [D, D], [xa, ya], ua, Z, X, R));
          ...
          if (this.end - this.start <= Mb || 0 === Mb) {
              ...
              switch (L) {
                ...
                case "bottom":
                  q && "column" == g
                    ? ((aa = na),
                      0 > U || (0 < U && f.reversed)
                        ? ((Ia = -6), ga.attr({ "text-anchor": "end" }))
                        : ((Ia = 6), ga.attr({ "text-anchor": "start" })))
                    : ((Ja = Ha / 2 + Ka / 2), (ga.x = -(Pa / 2 + 2)));
                  break;
                case "middle":
                  "column" == g &&
                    (q
                      ? ((Ja = -(Ka / 2) + this.fontSize / 2),
                        (Ia = -(D - N) / 2 - I),
                        Math.abs(D - N) < Pa &&
                ...
                case "inside":
                  q
                    ? ((Ja = -(Ka / 2) + this.fontSize / 2),
                      (Ia = 0 > da ? Pa / 2 + 6 : -Pa / 2 - 6))
                    : (Ja = 0 > da ? Ka : -Ka);
              }
              if (ga) {
                if (isNaN(ia) || isNaN(aa)) ga.remove(), (ga = null);
            ...
            if ("regular" == H || "100%" == H) {
              ...
              if (Qb) {
                ...
                q
                  ? ((Za = C),
                    (Ya = 0 > U ? D - Sb / 2 - 2 - $a : D + Sb / 2 + 3 + $a))
                  : ((Ya = D),
                    (Za = 0 > U ? C + Tb / 2 + $a : C - Tb / 2 - 3 - $a));
                Qa.translate(Ya, Za);
                f.totals[J] = Qa;
                q
                  ? (0 > Za || Za > n) && Qa.remove()
      ...
      (g.seqAn
        ? (a.set.hide(),
          ...
          (a = setTimeout(function () {
            g.animate.call(g);
          }, (c / (g.end - g.start + 1)) * (b - g.start) * 1e3)),
          g.timeOuts.push(a))
        : g.animate(a));
  },
  ...
  drawLineGraph: function (a, b, c, d) {
    ...
    if (1 < a.length) {
      ...
      void 0 === s ||
        e.useNegativeColorIfDown ||
        ((n = AmCharts.line(h, a, b, s, q, n, v, !1, !0)), l.push(n));
      if (0 < f || 0 < t)
        if (
          ((n = a.join(";").split(";")),
          (q = b.join(";").split(";")),
          ...
          "serial" == m
            ? 0 < c.length
              ? (c.reverse(), d.reverse(), (n = a.concat(c)), (q = b.concat(d)))
              : e.rotate
              ? (q.push(q[q.length - 1]),
                n.push(u),
                q.push(q[0]),
            ...
            : "xy" == m &&
              (b = e.fillToAxis) &&
              (AmCharts.isString(b) && (b = g.getValueAxisById(b)),
              "H" == b.orientation
                ? ((u = "top" == b.position ? 0 : b.viH),
                  n.push(n[n.length - 1]),
                  q.push(u),
                  n.push(n[0]),
                  q.push(u),
                ...
                : ((u = "left" == b.position ? 0 : b.viW),
                  ...
                  q.push(q[0]),
                  n.push(n[0]))),
          (a = e.gradientRotation),
          0 < f &&
            ((g = AmCharts.polygon(h, n, q, r, f, 1, "#000", 0, a)),
            g.pattern(e.pattern),
            k.push(g)),
          w || void 0 !== s)
        )
          isNaN(t) && (t = f),
            w || (w = s),
            (h = AmCharts.polygon(h, n, q, w, t, 1, "#000", 0, a)),
            h.pattern(e.pattern),
            l.push(h),
            l
              .click(function (a) {
  ...
  drawSmoothedGraph: function (a, b, c, d) {
    if (1 < a.length) {
      ...
      g.push(k.path);
      void 0 !== q &&
        ((l = new AmCharts.Bezier(f, a, b, q, w, l, p, 0, e)), h.push(l.path));
      0 < m &&
        ((k = a.join(";").split(";")),
        (n = b.join(";").split(";")),
        (l = ""),
        0 < c.length
          ...
          : (this.rotate
              ...
              : ((l += " L" + a[a.length - 1] + "," + v),
                (l += " L" + a[0] + "," + v)),
            (l += " L" + a[0] + "," + b[0])),
        (c = new AmCharts.Bezier(f, k, n, NaN, 0, 0, p, m, e, l)),
        c.path.pattern(this.pattern),
        g.push(c.path),
        r || void 0 !== q) &&
        (s || (s = m),
        r || (r = q),
        (a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, r, s, e, l)),
        a.path.pattern(this.pattern),
        h.push(a.path));
      this.applyMask(h, g);
    }
  },
  launchAnimation: function () {
    ...
    if (0 < b && !a.animationPlayed) {
      var c = a.set,
        d = a.bulletSet;
      AmCharts.VML ||
        (c.attr({ opacity: a.startAlpha }), d.attr({ opacity: a.startAlpha }));
      c.hide();
      d.hide();
      a.seqAn
  ...
  animateGraphs: function () {
    ...
    b &&
      (this.rotate
        ? (b.translate(-1e3, e), c.translate(-1e3, e))
        : (b.translate(d, -1e3), c.translate(d, -1e3)),
      b.animate({ opacity: 1, translate: d + "," + e }, f, a),
      c.animate({ opacity: 1, translate: d + "," + e }, f, a));
  },
  animate: function (a) {
    var b = this.chart,
  ...
  createBullet: function (a, b, c, d) {
    ...
    isNaN(h) ||
      (isNaN(g) || (f = ((g - k) / (h - k)) * (l - m) + m), k == h && (f = l));
    h = f;
    this.bulletAxis &&
      ((f = a.values.error),
      isNaN(f) || (g = f),
      (f = this.bulletAxis.stepWidth * g));
    f < this.minBulletSize && (f = this.minBulletSize);
    this.rotate
      ? (b = a.isNegative ? b - e : b + e)
      : (c = a.isNegative ? c + e : c - e);
    var n,
      m = this.bulletColorR;
    ...
    "xy" == this.chart.type &&
      this.valueField &&
      ((p = this.pattern), a.pattern && (p = a.pattern));
    e = this.bullet;
    a.bullet && (e = a.bullet);
    ...
    if ("none" != this.bullet || a.bullet)
      n = AmCharts.bullet(d, e, f, m, q, g, k, l, h, 0, p);
    if (this.customBullet || a.customBullet)
      (p = this.customBullet),
        a.customBullet && (p = a.customBullet),
        p &&
          (n && n.remove(),
          "function" == typeof p
            ? ((n = new p()),
              ...
              a.bulletConfig &&
                ...
                (n.bulletConfig = a.bulletConfig)),
              n.write(d),
              (n = n.set))
            : (this.chart.path && (p = this.chart.path + p),
              (n = d.set()),
              (d = d.image(p, 0, 0, f, f)),
              n.push(d),
              this.centerCustomBullets && d.translate(-f / 2, -f / 2)));
    n &&
  ...
  handleRollOver: function (a, b) {
    if (a) {
      ...
      c.chartCursor &&
        "serial" == c.type &&
        ((d = !1),
        !c.chartCursor.valueBalloonsEnabled && this.showBalloon && (d = !0));
      if (d) {
...
AmCharts.ChartCursor = AmCharts.Class({
  ...
  createCursor: function () {
    ...
    (h = this.fullRectSet)
      ? (h.push(b), h.translate(this.x, this.y))
      : this.set.push(b);
    a
      ? (e && (g.pointerWidth = 0),
        "right" == d
          ? e
            ? g.setBounds(n, p + m, n + q + l, p + r + m)
            : g.setBounds(n + q + l + f, p + m, n + q + 1e3, p + r + m)
          : e
          ? g.setBounds(n, p, q + n, r + p)
          : g.setBounds(-1e3, -1e3, n - s - f, p + r + 15))
      : ((g.maxWidth = q),
        c.parseDates && ((s = 0), (g.pointerWidth = 0)),
        "top" == d
          ? e
            ? g.setBounds(n + l, p + m, q + l + n, r + p)
            : g.setBounds(n + l, -1e3, q + l + n, p + m - s - f)
          : e
          ? g.setBounds(n, p, q + n, r + p - s)
          : g.setBounds(n, p + r + s + f - 1, n + q, p + r + s + f));
    this.hideCursor();
  },
  ...
  detectMovement: function () {
    ...
    if (a.mouseIsOver) {
      var b = a.mouseX - this.x,
        c = a.mouseY - this.y;
      -0.5 < b && b < this.width + 1 && 0 < c && c < this.height
        ? (this.drawing
            ? this.rolledOver || a.setMouseCursor("crosshair")
            : this.pan && (this.rolledOver || a.setMouseCursor("move")),
          (this.rolledOver = !0),
          this.setPosition())
  ...
  getMousePosition: function () {
    ...
    a = this.chart;
    this.rotate
      ? ((a = a.mouseY - this.y), 0 > a && (a = 0), a > c && (a = c))
      : ((a = a.mouseX - this.x - 1), 0 > a && (a = 0), a > b && (a = b));
    return a;
  },
  updateCrosshair: function () {
    ...
    0 < this.cursorAlpha &&
      (d.show(), e.show(), d.translate(b, 0), e.translate(0, c));
    this.zooming &&
      (a.hideXScrollbar && (b = NaN),
  ...
  arrangeBalloons2: function () {
    ...
    for (e = 0; e < f; e++) {
      ...
      0 < e &&
        b - h < d + 3 &&
        (g.setBounds(c, d + 3, c + this.width, d + h + 3),
        (g.prevX = this.prevX[k]),
        (g.prevY = this.prevY[k]),
        (g.prevTX = this.prevTX[k]),
        (g.prevTY = this.prevTY[k]),
        g.draw());
      g.set && g.set.show();
      ...
      if (!d.hidden && d.balloonText) {
        ...
        if (!isNaN(f)) {
          ...
          d = AmCharts.circle(
            a,
            this.bulletSize / 2,
            this.chart.getBalloonColor(d, e, !0),
            d.cursorBulletAlpha
          );
          d.translate(h, f);
  ...
  zoom: function (a, b, c, d) {
    ...
    var f;
    this.rotate
      ? (this.selectionPosY = f = e.mouseY)
      : (this.selectionPosX = f = e.mouseX);
    this.start = a;
    this.end = b;
    this.startTime = c;
    this.endTime = d;
    ...
    this.fullWidth &&
      ((f = 1),
      d.parseDates && !d.equalSpacing && (f = d.minDuration()),
      e
        ? (this.extraWidth = c = a * f)
        : ((this.extraWidth = b = a * f), (this.categoryBalloon.minWidth = b)),
      this.line && this.line.remove(),
      (this.line = AmCharts.rect(
        this.container,
        b,
        c,
        this.cursorColor,
    ...
    if ("cursor" == this.type) {
      if (((this.tempPosition = NaN), AmCharts.ifArray(this.data)))
        isNaN(a) && (a = this.getMousePosition()),
          (a != this.previousMousePosition ||
            !0 === this.zoomed ||
            this.oneBalloonOnly) &&
            !isNaN(a) &&
            ("mouse" == this.cursorPosition && (this.tempPosition = a),
            isNaN(c) && (c = this.chart.categoryAxis.xToIndex(a)),
            c != this.previousIndex ||
              this.zoomed ||
              "mouse" == this.cursorPosition ||
              this.oneBalloonOnly) &&
    ...
    if (a)
      for (var b = 0; b < a.length; b++) {
        var c = a[b],
          d = c.bulletGraphics;
        d &&
          (d.translate(c.bx, c.by, 1),
          (c = c.graph),
          isNaN(this.graphBulletAlpha) ||
            (d.setAttr("fill-opacity", c.bulletAlpha),
  ...
  updateCursor: function (a, b) {
    ...
    this.drawingNow &&
      ...
      (this.drawingLine = AmCharts.line(
        this.container,
        [this.x + this.drawStartX, this.x + e],
        [this.y + this.drawStartY, this.y + f],
        this.cursorColor,
        1,
        1
      )));
      ...
      if (q) {
        ...
        if (c.mouseIsOver || z || K || this.forceShow)
          if (((this.forceShow = !1), K)) {
            ...
            0 !== e &&
              ((h = { type: "zoomed", target: this }),
              (h.chart = this.chart),
              g.parseDates && !g.equalSpacing
                ? (c + e > y && (e = y - c),
                  z + e < u && (e = u - z),
                  (h.start = Math.round(z + e)),
                  (h.end = Math.round(c + e)),
                  this.fire(h.type, h))
                : H + e >= this.data.length ||
                  0 > l + e ||
                  ((h.start = l + e), (h.end = H + e), this.fire(h.type, h)));
          } else {
            "start" == E
              ? (r -= g.cellWidth / 2)
              : "mouse" == E &&
                (c.mouseIsOver
                  ? (r = s ? f - 2 : e - 2)
                  : isNaN(this.tempPosition) || (r = this.tempPosition - 2));
            if (s) {
              if (0 > r)
                if (z) r = 0;
                else {
            ...
            if (0 < this.cursorAlpha) {
              var L = this.line;
              s
                ? ((u = 0), (y = r + k), d && (y -= g.cellWidth / 2))
                : ((u = r), (y = 0), d && (u -= g.cellWidth / 2));
              w = this.animationDuration;
              0 < w && !this.zooming
                ? isNaN(this.previousX)
                  ? L.translate(u, y)
                  : (L.translate(this.previousX, this.previousY),
                    L.animate({ translate: u + "," + y }, w, "easeOutSine"))
                : L.translate(u, y);
              this.previousX = u;
              this.previousY = y;
              L.show();
            ...
            z &&
              (d && L.hide(),
              s
                ? this.updateSelectionSize(NaN, r)
                : this.updateSelectionSize(r, NaN));
            w = !0;
            z && (w = !1);
            this.categoryBalloonEnabled && w
              ? (s
                  ? (v &&
                      ("right" == A
                        ? t.setBounds(l, m + k, l + n + h, m + r + k)
                        : t.setBounds(l, m + k, l + n + h, m + r)),
                    "right" == A
                      ? v
                        ? t.setPosition(l + n + h, m + r + k)
                        : t.setPosition(l + n + h + F, m + r + k)
                      : v
                      ? t.setPosition(l, m + r)
                      : t.setPosition(l - F, m + r))
                  : "top" == A
                  ? v
                    ? t.setPosition(l + r + h, m + k)
                    : t.setPosition(l + r + h, m + k - F + 1)
                  : v
                  ? t.setPosition(l + r, m + p)
                  : t.setPosition(l + r, m + p + F - 1),
                (u = this.categoryBalloonFunction)
                  ? t.showBalloon(u(q.category))
                  : g.parseDates
                  ? ((g = AmCharts.formatDate(
                      q.category,
                      this.categoryBalloonDateFormat
                    )),
                    -1 != g.indexOf("fff") &&
                      (g = AmCharts.formatMilliseconds(g, q.category)),
                    t.showBalloon(g))
                  : t.showBalloon(AmCharts.fixNewLines(q.category)))
              : t.hide();
              ...
              for (g = 0; g < I.length; g++)
                (u = I[g]),
                  u.showBalloon &&
                    !u.hidden &&
                    u.balloonText &&
                    ((y = q.axes[u.valueAxis.id].graphs[u.id]),
                    (t = y.y),
                    isNaN(t) ||
                      (s
                        ? Math.abs(e - t) < k &&
            ...
            if (a != this.previousIndex || H != this.previousMostCloseGraph)
              if (
                ...
                this.destroyValueBalloons(),
                (this.resizedBullets = []),
                I && this.valueBalloonsEnabled && w && c.balloon.enabled)
              ) {
                ...
                for (g = 0; g < I.length; g++)
                  if (
                    ((u = I[g]),
                    (t = NaN),
                    (!this.oneBalloonOnly || u == H) &&
                      u.showBalloon &&
                      !u.hidden &&
                      u.balloonText &&
                      ("step" == u.type &&
                        "left" == u.stepDirection &&
                        (q = this.data[a + 1]),
                      q))
                  ) {
                    if ((y = q.axes[u.valueAxis.id].graphs[u.id])) t = y.y;
                    if (
                      this.showNextAvailable &&
                      isNaN(t) &&
                      a + 1 < this.data.length
                    )
                      for (k = a + 1; k < this.data.length; k++)
                        if ((r = this.data[k]))
                          if (
                            ((y = r.axes[u.valueAxis.id].graphs[u.id]),
                            (t = y.y),
                            !isNaN(t))
                          )
                            break;
                    if (!isNaN(t)) {
                      ...
                      if (s) {
                        if (((k = t), 0 > r || r > p)) v = !1;
                      } else if (((k = r), (r = t), 0 > k || k > n + h + 1))
                        v = !1;
                      v &&
                        (1 != this.graphBulletSize &&
                          AmCharts.isModern &&
                          (v = y.bulletGraphics) &&
                          (v.getBBox(),
                          v.translate(y.bx, y.by, this.graphBulletSize),
                          this.resizedBullets.push(y),
                          (A = this.graphBulletAlpha),
                          isNaN(A) ||
                            (v.setAttr("fill-opacity", A),
                            v.setAttr("stroke-opacity", A))),
                        (v = u.valueBalloon),
                        (A = c.getBalloonColor(u, y)),
                        v.setBounds(l, m, l + n, m + p),
                        (v.pointerOrientation = "H"),
                        (F = this.balloonPointerOrientation),
                        "vertical" == F && (v.pointerOrientation = "V"),
                        "horizontal" == F && (v.pointerOrientation = "H"),
                        v.changeColor(A),
                        void 0 !== u.balloonAlpha &&
                          (v.fillAlpha = u.balloonAlpha),
                        void 0 !== u.balloonTextColor &&
                          (v.color = u.balloonTextColor),
                        v.setPosition(k + l, r + m),
                        (k = c.formatString(u.balloonText, y, !0)),
                        (r = u.balloonFunction) && (k = r(y, u).toString()),
                        "" !== k &&
                          (s ? v.showBalloon(k) : ((v.text = k), (v.show = !0)),
                          w.push({ yy: t, balloon: v })),
                        !s &&
                          v.set &&
                          (v.set.hide(), (u = v.textDiv)) &&
            ...
            b
              ...
              : ((this.skipZoomDispatch = !0), c.updateLegendValues(a));
        ...
        if (this.pan) this.rolledOver = !1;
          ...
          if ("cursor" == this.type)
            this.rotate
              ...
              : (this.selectionPosX = e = d),
              (2 > Math.abs(e - this.initialMouse) &&
                this.fromIndex == this.index) ||
                (this.index < this.fromIndex
                  ? ((c.end = this.fromIndex), (c.start = this.index))
                  : ((c.end = this.index), (c.start = this.fromIndex)),
                (e = a.categoryAxis),
                e.parseDates &&
                  !e.equalSpacing &&
                  ((c.start = b[c.start].time),
                  (c.end = a.getEndTime(b[c.end].time))),
                this.skipZoomDispatch || this.fire(c.type, c));
          else {
            var g = this.initialMouseX,
              h = this.initialMouseY;
            (3 > Math.abs(d - g) && 3 > Math.abs(e - h)) ||
              ((b = Math.min(g, d)),
              (f = Math.min(h, e)),
              (d = Math.abs(g - d)),
              (e = Math.abs(h - e)),
              a.hideXScrollbar && ((b = 0), (d = this.width)),
              a.hideYScrollbar && ((f = 0), (e = this.height)),
              (c.selectionHeight = e),
              (c.selectionWidth = d),
              (c.selectionY = f),
              (c.selectionX = b),
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({
  ...
  draw: function () {
    ...
    var f, g;
    c
      ? ((f = a.scrollbarHeight), (g = d.plotAreaHeight))
      : ((g = a.scrollbarHeight), (f = d.plotAreaWidth));
    a.width = f;
    if ((a.height = g) && f) {
      var h = AmCharts.rect(
        b,
        ...
        (l
          ? ((a = r - d),
            ...
            0 > a
              ...
              : (0 === a && (a = 0.1), g.setAttr("height", a)))
          : ((a = q - c),
            a + c > n + e && (a = n - c + e),
            0 > a
              ? ((this.resizingRight = !1), (b = this.resizingLeft = !0))
              : (0 === a && (a = 0.1), g.setAttr("width", a)))),
      this.resizingLeft &&
        (l
          ? ((c = d),
            (d = r),
  ...
  clipDragger: function (a) {
    ...
    if (b) {
      ...
      if (this.rotate) {
        ...
        ((d = 0), (b = this.height + 1), this.clipX != c || this.clipW != e)
      )
        f = !0;
      f &&
        (this.clipAndUpdate(c, d, e, b),
  ...
  updateDragIconPositions: function () {
    ...
    this.rotate
      ? ((f = this.dragIconWidth),
        ...
        d.translate(this.x + (h - g) / 2, this.y + c - f / 2),
        e.translate(this.x + (h - g) / 2, this.y + c + a.height - f / 2))
      : ((f = this.dragIconHeight),
        (g = this.dragIconWidth),
        d.translate(this.x + b - g / 2, this.y + (h - f) / 2),
        e.translate(this.x + b - g / 2 + a.width, this.y + (h - f) / 2));
  },
  ...
  relativeZoom: function (a, b) {
    ...
    this.updateScrollbarSize(
      b,
      this.rotate ? b + this.height / a : b + this.width / a
    );
  },
  destroy: function () {
    this.clear();
  ...
  iconRollOver: function () {
    this.rotate
      ? this.chart.setMouseCursor("n-resize")
      : this.chart.setMouseCursor("e-resize");
    this.handleMouseOver();
  },
  getDBox: function () {
  ...
  handleBgClick: function () {
    if (!this.resizingRight && !this.resizingLeft) {
      ...
      k
        ? ((a = "y"),
          (b = b.mouseY - e / 2 - g),
          (b = AmCharts.fitToBounds(b, 0, this.height - e)))
        : ((a = "x"),
          (b = b.mouseX - f / 2 - h),
      ...
      this.updateOnReleaseOnly
        ? ((this.skipEvent = !1),
          ...
          this.clipDragger())
        : ((b = Math.round(b)),
          k ? d.animate({ y: b }, c, ">") : d.animate({ x: b }, c, ">"));
    }
  },
...
AmCharts.ChartScrollbar = AmCharts.Class({
  ...
  init: function () {
    ...
    AmCharts.isString(this.graph) &&
      (this.graph = AmCharts.getObjById(b.graphs, this.graph));
    if ((a = this.graph)) {
      var c = this.valueAxis;
      c ||
        ((this.valueAxis = c = new AmCharts.ValueAxis()),
        (c.visible = !1),
        (c.scrollbar = !0),
        (c.axisItemRenderer = AmCharts.RecItem),
        (c.axisRenderer = AmCharts.RecAxis),
        (c.guideFillRenderer = AmCharts.RecFill),
        (c.labelsEnabled = !1),
        (c.chart = b));
      b = this.unselectedGraph;
      b ||
        ((b = new AmCharts.AmGraph()),
        (b.scrollbar = !0),
    ...
    if (this.skipEvent) this.skipEvent = !1;
      ...
      if (g.parseDates && !g.equalSpacing) {
        if (
          ...
          (g = Math.round(b / h) + d),
          (b = this.dragging
            ? g + this.timeDifference
            : Math.round((b + c) / h) + d),
          g > b && (g = b),
          0 < e &&
            b - g < e &&
            ((b = Math.round(g + (b - g) / 2)),
            (c = Math.round(e / 2)),
            (g = b - c),
            (b += c)),
          b > a && (b = a),
          ...
          g < d && (g = d),
          g + e > b && (b = g + e),
          g != this.startTime || b != this.endTime)
        )
          (this.startTime = g),
            (this.endTime = b),
            (f.start = g),
            (f.end = b),
            (f.startDate = new Date(g)),
  ...
  zoomScrollbar: function () {
    ...
    d.parseDates && !d.equalSpacing
      ? ((c = d.stepWidth),
        ...
        (b = c * (this.endTime - d)))
      : ((a = c[this.start].x[d.id]),
        (b = c[this.end].x[d.id]),
        (c = d.stepWidth),
        d.startOnAxis || ((d = c / 2), (a -= d), (b += d)));
    this.stepWidth = c;
...
AmCharts.AmBalloon = AmCharts.Class({
    ...
    if (!isNaN(a)) {
      ...
      if (this.show) {
        ...
        "H" != w
          ? ((A = a - z / 2),
            b < h + u + 10 && "down" != w
              ? ((K = !0), d && (b += y), (y = b + v), (this.deltaSignY = -1))
              : (d && (b -= y), (y = b - u - v), (this.deltaSignY = 1)))
          : (2 * v > u && (v = u / 2),
            (y = b - u / 2),
            a < g + (k - g) / 2
              ? ((A = a + v), (this.deltaSignX = -1))
              : ((A = a - z - v), (this.deltaSignX = 1)));
        y + u >= l && (y = l - u);
        y < h && (y = h);
        A < g && (A = g);
        A + z > k && (A = k - z);
        ...
        0 < t || 0 === v
          ? (0 < s &&
            ...
            this.showBullet &&
              ((H = AmCharts.circle(e, F, q, this.fillAlpha)), f.push(H)))
          : ((q = []),
            (t = []),
            "H" != w
              ? ((g = a - A),
              ...
              : ((q = b - y),
                q > u - v && (q = u - v),
                q < v && (q = v),
                (t = [0, q - v, b - y, q + v, u, u, 0, 0]),
                (q =
                  a < g + (k - g) / 2
                    ? [0, 0, A < a ? 0 : a - A, 0, 0, z, z, 0]
                    : [z, z, A + z > a ? z : a - A, z, z, 0, 0, z])),
            0 < s &&
              ((a = AmCharts.polygon(e, q, t, n, 0, r, I, s)),
              a.translate(1, 1),
              f.push(a)),
            (n = AmCharts.polygon(
              e,
        ...
        0 < this.animationDuration &&
          !d &&
          !isNaN(this.prevX) &&
          (f.translate(this.prevX, this.prevY),
          f.animate({ translate: A - e + "," + y }, b, "easeOutSine"),
          m &&
            ((E.left = this.prevTX + "px"),
            (E.top = this.prevTY + "px"),
  ...
  followMouse: function () {
    if (this.follow && this.show) {
      ...
      if (a != this.previousX || b != this.previousY)
        if (
          ((this.previousX = a), (this.previousY = b), 0 === this.cornerRadius)
        )
          this.draw();
        else {
          var c = this.set;
  ...
  hide: function () {
    ...
    if (0 < b) {
      ...
      var d = a.set;
      d &&
        (d.setAttr("opacity", a.fillAlpha),
        (a.fadeAnim1 = d.animate({ opacity: 0 }, b, "easeInSine")));
      a.textDiv &&
        (a.fadeAnim2 = c.animate(
          { node: a.textDiv },
          "opacity",
          1,
          0,
...
AmCharts.AmCoordinateChart = AmCharts.Class({
  ...
  initChart: function () {
    ...
    var a = this.categoryAxis;
    a &&
      (this.categoryAxis = AmCharts.processObject(
        a,
  ...
  parseSerialData: function () {
    ...
    if (e) {
      ...
      var m,
        ...
        q;
      f &&
        ((b = AmCharts.extractPeriod(h.minPeriod)),
        (m = b.period),
        (n = b.count),
        (q = AmCharts.getPeriodDuration(m, n)));
      var r = {};
      this.lookupTable = r;
      var s,
        v = this.dataDateFormat,
        w = {};
      for (s = 0; s < e.length; s++) {
        ...
        if (
          f &&
          ((b = h.categoryFunction
            ? h.categoryFunction(b, u, h)
            : b instanceof Date
            ? AmCharts.newDate(b, h.minPeriod)
            : v
            ? AmCharts.stringToDate(b, v)
            : new Date(b)),
          (b = AmCharts.resetDateToMin(b, m, n, h.firstDayOfWeek)),
          (t.category = b),
          (t.time = b.getTime()),
          isNaN(t.time))
        )
  ...
  processGuides: function () {
    ...
    if (a)
      for (var c = 0; c < a.length; c++) {
        ...
        var e = d.valueAxis;
        e
          ? (AmCharts.isString(e) && (e = this.getValueAxisById(e)),
            e ? e.addGuide(d) : this.valueAxes[0].addGuide(d))
          : isNaN(d.value) || this.valueAxes[0].addGuide(d);
      }
  },
  ...
  parseData: function () {
    ...
    if (void 0 !== b) {
      ...
      for (e = 0; e < c; e++) {
        ...
        f.pattern = g;
        f.visibleInLegend = AmCharts.toBoolean(
          h[this.visibleInLegendField],
          !0
        );
        g = h[this.alphaField];
      ...
      for (e = 0; e < a.length; e++)
        c
          ? (g = AmCharts.adjustLuminosity(c, (e * d) / 100))
          : ((g = this.colors[e]),
...
AmCharts.AmRectangularChart = AmCharts.Class({
  ...
  resetMargins: function () {
    ...
    if ("serial" == this.type) {
      ...
      for (b = 0; b < c.length; b++)
        (d = c[b]),
          d.ignoreAxisWidth ||
            (d.setOrientation(!1), d.fixAxisPosition(), (a[d.position] = !0));
    }
  ...
  measureMargins: function () {
    ...
    d.top &&
      h < c + this.titleHeight &&
      (this.marginTop = Math.round(this.marginTop - h + c + this.titleHeight));
    d.bottom &&
      b > f - c &&
  ...
  drawZoomOutButton: function () {
    ...
    var l = a.zoomOutButton,
      n;
    l &&
      (l.fontSize && (d = l.fontSize),
      l.color && (c = l.color),
      l.backgroundColor && (h = l.backgroundColor),
      isNaN(l.backgroundAlpha) ||
        (a.zoomOutButtonRollOverAlpha = l.backgroundAlpha));
    var p = (l = 0);
    void 0 !== a.pathToImages &&
      f &&
      ((n = a.container.image(a.pathToImages + f, 0, 0, e, e)),
      b.push(n),
      (n = n.getBBox()),
      (l = n.width + 5));
    void 0 !== g &&
      ((c = AmCharts.text(a.container, g, c, a.fontFamily, d, "start")),
      (d = c.getBBox()),
    ...
    n = h.getBBox();
    b.translate(
      a.marginLeftReal + a.plotAreaWidth - n.width + m,
      a.marginTopReal + m
    );
    b.hide();
  ...
  updateChartCursor: function () {
    var a = this.chartCursor;
    a &&
      ((a = AmCharts.processObject(a, AmCharts.ChartCursor, this.theme)),
  ...
  processScrollbars: function () {
    ...
    a &&
      ((a = AmCharts.processObject(a, AmCharts.ChartScrollbar, this.theme)),
  ...
  addChartCursor: function (a) {
    ...
    a &&
      (this.listenTo(a, "changed", this.handleCursorChange),
  ...
  adjustMargins: function (a, b) {
    ...
    "top" == a.position
      ? b
        ? (this.marginLeftReal += c)
        : (this.marginTopReal += c)
      : b
      ? (this.marginRightReal += c)
      : (this.marginBottomReal += c);
  },
  ...
  updateChartScrollbar: function (a, b) {
    if (a) {
      ...
      "top" == a.position
        ? b
          ? ((a.y = c), (a.x = d - e - h))
          : ((a.y = c - e + g - 1 - h), (a.x = d + f))
        : b
        ? ((a.y = c + g), (a.x = d + this.plotAreaWidth + f + h))
        : ((a.y = c + this.plotAreaHeight + h), (a.x = this.marginLeftReal));
    }
  },
  showZB: function (a) {
    var b = this.zbSet;
...
AmCharts.TrendLine = AmCharts.Class({
  ...
  draw: function () {
    ...
    h &&
      (k &&
        (k instanceof Date ||
          (k = u ? AmCharts.stringToDate(k, u) : new Date(k)),
        (a.initialDate = k),
        (d = h.dateToCoordinate(k))),
      l && (d = h.categoryToCoordinate(l)),
      m &&
        (m instanceof Date ||
          (m = u ? AmCharts.stringToDate(m, u) : new Date(m)),
        (a.finalDate = m),
        (e = h.dateToCoordinate(m))),
      n && (e = h.categoryToCoordinate(n)));
    q &&
      !t &&
      (isNaN(r) || (d = q.getCoordinate(r)),
      isNaN(s) || (e = q.getCoordinate(s)));
    p &&
      !t &&
      (isNaN(v) || (f = p.getCoordinate(v)),
      isNaN(w) || (g = p.getCoordinate(w)));
    isNaN(d) ||
      isNaN(e) ||
      isNaN(f) ||
      isNaN(f) ||
      (b.rotate ? ((h = [f, g]), (e = [d, e])) : ((h = [d, e]), (e = [f, g])),
      (f = a.lineColor),
      (d = AmCharts.line(
        c,
        h,
      ...
      (p =
        ((n * p) / Math.abs(n * p)) *
        Math.sqrt(Math.pow(n, 2) + Math.pow(p, 2))),
      (n = Math.asin(n / p)),
      (p = (90 * Math.PI) / 180 - n),
      (n = Math.abs(5 * Math.cos(p))),
      (p = Math.abs(5 * Math.sin(p))),
      g.push(h[1] - l * p, h[0] - l * p),
      k.push(e[1] + m * n, e[0] + m * n),
      (h = AmCharts.polygon(c, g, k, f, 0.005, 0)),
      (c = c.set([h, d])),
...
AmCharts.polygon = function (a, b, c, d, e, f, g, h, k, l, m) {
  ...
  f = AmCharts.dy;
  a.handDrawn &&
    ((c = AmCharts.makeHD(b, c, a.handDrawScatter)), (b = c[0]), (c = c[1]));
  g = Math.round;
...
AmCharts.triangle = function (a, b, c, d, e, f, g, h) {
  ...
  var k;
  0 === c &&
    (k = " M" + -b + "," + b + " L0," + -b + " L" + b + "," + b + " Z");
  180 == c &&
    (k = " M" + -b + "," + -b + " L0," + b + " L" + b + "," + -b + " Z");
  90 == c &&
    (k = " M" + -b + "," + -b + " L" + b + ",0 L" + -b + "," + b + " Z");
  270 == c &&
    (k = " M" + -b + ",0 L" + b + "," + b + " L" + b + "," + -b + " Z");
...
AmCharts.handDrawnLine = function (a, b, c, d, e, f, g, h, k, l, m) {
  ...
  for (m = 1; m < b.length; m++)
    for (
      var p = [b[m - 1], b[m]],
        q = [c[m - 1], c[m]],
        q = AmCharts.makeHD(p, q, a.handDrawScatter),
        p = q[0],
        q = q[1],
        r = 1;
      r < p.length;
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
  ...
  n &&
    ((z["fill-opacity"] = 0),
    (z["stroke-opacity"] = l["stroke-opacity"] / 2),
    (z.stroke = l.stroke));
  0 < k &&
    (r
      ? ((F = " M" + s + "," + (w + k) + " L" + t + "," + (u + k)),
      ...
      : ((F =
        ...
        0 < h &&
          (F += " A" + h + "," + q + ",0," + K + ",0," + s + "," + (w + k))),
    (F += " Z"),
    (F = a.path(F, void 0, void 0, "1000,1000").attr(z)),
    d.push(F),
    (F = a
      .path(
        " M" +
...
AmCharts.AmDraw = AmCharts.Class({
  construct: function (a, b, c, d) {
    ...
    AmCharts.hasSVG =
      ...
      !!document.createElementNS(AmCharts.SVG_NS, "svg").createSVGRect;
    1 > b && (b = 10);
    1 > c && (c = 10);
    this.div = a;
    this.width = b;
    ...
    if (AmCharts.hasSVG) {
      ...
      b.appendChild(
        document.createTextNode("JavaScript chart by amCharts " + d.version)
      );
      e.appendChild(b);
      AmCharts.rtl &&
        (e.setAttribute("direction", "rtl"),
        (e.style.left = "auto"),
        (e.style.right = "0px"));
...
AmCharts.VMLRenderer = AmCharts.Class({
    ...
    if (void 0 !== c) {
      ...
      "text" == f &&
        ("text-anchor" == b &&
          ...
          "middle" == c &&
            ((g.marginLeft = -(h / 2) + "px"), (g.textAlign = "center")),
      ...
      if ("shape" == f) {
        ...
        "stroke-width" == b &&
          (d ? (f.weight = c) : f.setAttribute("weight", c));
        "stroke-opacity" == b &&
        ...
        "rx" == b &&
          (d ? (e.arcSize = c + "%") : e.setAttribute("arcsize", c + "%"));
      }
    }
  },
  attr: function (a, b) {
  ...
  move: function (a, b, c) {
    ...
    "oval" == a.shapeType &&
      ((b -= AmCharts.removePx(e.width) / 2),
      (c -= AmCharts.removePx(e.height) / 2));
    a = a.bw;
    isNaN(a) || ((b -= a), (c -= a));
    isNaN(b) ||
      isNaN(c) ||
      ((d.style.left = b + "px"), (d.style.top = c + "px"));
  },
  ...
  rotate: function (a, b, c) {
    if (0 !== Number(b)) {
      ...
      b /= Math.abs(b);
      a.left =
        g + k / 2 - (k / 2) * Math.cos(c) - ((b * d) / 2) * Math.sin(c) + 3;
  ...
  pattern: function (a, b) {
    ...
    c.fillColor = e;
    8 === document.documentMode
      ? ((d.type = "tile"), (d.src = b.url))
      : (d.setAttribute("type", "tile"), d.setAttribute("src", b.url));
  },
  update: function () {},
});
AmCharts.SVGRenderer = AmCharts.Class({
      ...
      e <= d
          ...
          "translate" == g
            ? ((h = c.from.split(",")),
              ...
              (l =
                0 === l - g
                  ? l
                  : Math.round(AmCharts[c.effect](0, e, g, l - g, d))),
              (c =
                0 === k - h
                  ? k
                  : Math.round(AmCharts[c.effect](0, e, h, k - h, d))),
              (g = "transform"),
              (c = "translate(" + l + "," + c + ")"))
            : ((k = Number(c.from)),
              (h = Number(c.to)),
              (l = h - k),
              (c = AmCharts[c.effect](0, e, k, l, d)),
              isNaN(c) && (c = h),
        ...
        : ("translate" == g
            ? ((k = c.to.split(",")),
              ...
              (k = Number(k[1])),
              f.translate(l, k))
            : ((h = Number(c.to)), this.setAttr(f, g, h)),
          this.animations.splice(a, 1));
    }
  },
  getBBox: function (a) {
  ...
  clipRect: function (a, b, c, d, e) {
    ...
    var h = f.parentNode;
    h &&
      ((f = document.createElementNS(AmCharts.SVG_NS, "clipPath")),
  ...
  setText: function (a, b) {
    var c = a.node;
    c &&
      (c.removeChild(c.firstChild), c.appendChild(document.createTextNode(b)));
  },
...
AmCharts.AmLegend = AmCharts.Class({
  ...
  invalidateSize: function () {
    ...
    this.entries = [];
    this.valueLabels = [];
    (AmCharts.ifArray(this.legendData) || AmCharts.ifArray(this.data)) &&
      this.drawLegend();
  },
  drawLegend: function () {
    var a = this.chart,
    ...
    var k;
    void 0 !== c
      ? (k = AmCharts.toCoordinate(c, d))
      : "right" != b && "left" != b && (k = a.realWidth);
    "outside" == b
      ? ((k = f.offsetWidth),
        (e = f.offsetHeight),
        f.clientHeight && ((k = f.clientWidth), (e = f.clientHeight)))
      : (isNaN(k) || (f.style.width = k + "px"),
  ...
  arrangeEntries: function () {
    ...
    for (t = 0; t < v.length; t++) {
      ...
      z.translate(K, E);
      u++;
      !isNaN(k) && u >= k && ((u = 0), q++, (E = E + A + l), (A = 0));
      r.push(z);
    }
    w = r.getBBox();
    k = w.height + 2 * l - 1;
    "left" == a || "right" == a
      ? ((h = w.width + 2 * f), (g.style.width = h + b + c + "px"))
      : (h = h - b - c - 1);
    c = AmCharts.polygon(
      this.container,
      [0, h, h, 0],
    ...
    if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
      "center" == this.align
        ? (b = f + (h - w.width) / 2)
        : "right" == this.align && (b = f + h - w.width);
    r.translate(b, l + 1);
    ...
    if (!1 !== a.visibleInLegend) {
      ...
      if (this.useGraphSettings)
        if (
          ...
          "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m)
        )
          (g = k.set()),
      ...
      (f = this.switchType) &&
        "none" != f &&
        ("x" == f
          ? ((q = this.createX()), q.translate(l / 2, l / 2))
          : (q = this.createV()),
        (q.dItem = a),
        !0 !== a.hidden
          ? "x" == f
            ...
            : q.show()
          : "x" != f && q.hide(),
        this.switchable || q.hide(),
        this.addListeners(q, a),
        (a.legendSwitch = q),
        k.push(q));
      f = this.color;
      a.showBalloon &&
      ...
      g &&
        l <= q &&
        g.translate(p, l / 2 + this.ly - q / 2 + (q + 2 - l) / 2 - n);
      var r;
      d &&
        ...
        (r = this.labelWidth),
        (r = isNaN(r)
          ? AmCharts.text(this.container, d, f, b.fontFamily, q, "start")
          : AmCharts.wrappedText(
              this.container,
              d,
              f,
              b.fontFamily,
  ...
  clickLabel: function (a) {
    this.textClickEnabled
      ? a.hidden || this.dispatch("clickLabel", a)
      : this.switchable &&
        (!0 === a.hidden
          ? this.dispatch("showItem", a)
          : this.dispatch("hideItem", a));
    ...
    if (!1 !== a.visibleInLegend) {
      ...
      if (b.valueText && 0 < b.valueWidth) {
        ...
        b.useMarkerColorForValues &&
          ((f = a.color), a.legendKeyColor && (f = a.legendKeyColor()));
      ...
      c = b.container
        .rect(b.markerSize, 0, e, f, 0, 0)
        .attr({ stroke: "none", fill: "#ffffff", "fill-opacity": 0.005 });
      c.dItem = a;
...
AmCharts.resetDateToMin = function (a, b, c, d) {
  ...
  AmCharts.useUTC
    ? ((a = new Date()), a.setUTCFullYear(e, f, g), a.setUTCHours(h, k, l, m))
    : (a = new Date(e, f, g, h, k, l, m));
  return a;
};
