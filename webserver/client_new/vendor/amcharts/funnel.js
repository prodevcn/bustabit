    ...
    if (AmCharts.ifArray(u))
      if (0 < this.realWidth && 0 < this.realHeight) {
        ...
        var q = AmCharts.toCoordinate,
          ...
          z = g - q - a,
          w = AmCharts.toCoordinate(this.neckHeight, z),
          r = a + z - w;
        k && ((a = g - q), (r = a - z + w));
        this.firstSliceY = a;
        ...
        for (
          ...
          if (!0 !== c.hidden) {
            ...
            (!k && a + b > r) || (k && a - b < r)
              ? ((p = l / 2),
                n.push(h - m, h + m, h + p, h + p, h - p, h - p),
                k
                  ? ((d = b + (a - b - r)),
                    a < r && (d = 0),
                    e.push(a, a, a - d, a - b, a - b, a - d, a))
                  : ((d = b - (a + b - r)),
                    a > r && (d = 0),
                    e.push(a, a, a + d, a + b, a + b, a + d, a)),
                (C = !0))
              : (n.push(h - m, h + m, h + p, h - p),
                k ? e.push(a, a, a - b, a - b) : e.push(a, a, a + b, a + b));
            t.set();
            d = t.set();
            n = AmCharts.polygon(
              t,
            ...
            if ((e = this.gradientRatio)) {
              ...
              for (f = 0; f < e.length; f++)
                s.push(AmCharts.adjustLuminosity(c.color, e[f]));
              0 < s.length && n.gradient("linearGradient", s);
              c.pattern && n.pattern(c.pattern);
            }
            0 < D &&
              (this.chartCreated || d.setAttr("opacity", this.startAlpha));
            this.addEventListeners(d, c);
            c.ty0 = a - b / 2;
            this.labelsEnabled &&
              this.labelText &&
              c.percents >= this.hideLabelsPercent &&
              ((e = this.formatString(this.labelText, c)),
              (n = this.labelFunction) && (e = n(c, e)),
              (s = c.labelColor),
              s || (s = this.color),
              ...
              "right" == n &&
                ...
                C && (c.tx0 = h + p)),
              "left" == n &&
                ((c.tx0 = h - (m - b / 2 / E)), C && (c.tx0 = h - p), (s = A)),
              (c.label = e),
              (c.labelX = s),
              (c.labelY = f),
              (c.labelHeight = e.getBBox().height),
              e.translate(s, f),
              (m = e.getBBox()),
              (B = AmCharts.rect(
                t,
              ...
              B.translate(s + m.x, f + m.y),
              d.push(B),
              (c.hitRect = B),
              (F = e.getBBox().height),
              (B = f));
            (0 === c.alpha || (0 < D && !this.chartCreated)) && d.hide();
            a = k ? a - b : a + b;
            m = p;
