define([
    ...
    function getState(){
        return _.merge(
            ...
            _.pick(GameEngineStore, ['nyan', 'connectionState', 'maxWin', 'gameState']),
        ...
        render: function() {
            ...
            switch(this.state.connectionState) {
                ...
                default:
                    ...
                    document.getElementById('game-container-placeholder').style.display = "none";        
            }
            ...
            return D.div({ id: 'chart-inner-container', className: this.props.controlsSize, ref: 'container' },
                ...
                D.div({ className: 'max-profit ' + this.state.gameState , id: 'max-profit'},
