...
CREATE INDEX giveaways_created ON giveaways(created);
...
CREATE UNIQUE INDEX deposit_addresses_address_unique_idx ON deposit_addresses(address);

CREATE TABLE deposits (
    id                    bigserial NOT NULL,
    deposit_addresses_id  bigint    NOT NULL REFERENCES deposit_addresses(id),
    txid                  text      NOT NULL,
