...
function requestDevOtt(id, callback) {
    ...
    var options = {
        // url: 'https://www.bustabit.com/ott',//add by hades
...
module.exports = function(app) {
    ...
    app.get('/register', staticPageLogged('register', '/account'));
    app.get('/login', staticPageLogged('login', '/account'));
    ...
    app.get('/jackpothistory', user.jackpothistory);
    ...
    app.get('/update-password', restrict, user.updatePassword);
    ...
    // add by OS
    app.get('/affiliate', staticPageLogged('affiliate'));
    app.get('/change-password', restrict, user.changePassword);
    app.get('/two-factor', restrict, user.twoFactor);
    app.get('/transactions', restrict, user.transactions);
    app.get('/bonus', restrict, user.bonus);
    app.get('/bankroll', restrict, user.bankroll);
    app.get('/privacy-policy', staticPageLogged('terms'));
    // app.get('/update-password', restrict, user.updatePassword);
